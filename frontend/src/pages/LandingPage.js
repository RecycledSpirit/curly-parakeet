  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-amber-50 to-green-100 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-30">
        {/* Top Border Animals */}
        <div className="absolute top-2 left-2 w-32 h-32 bg-cover bg-center rounded-full border-4 border-white shadow-xl opacity-90" style={{backgroundImage: "url('https://images.unsplash.com/photo-1674980750262-260775bf2212?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2Mzl8MHwxfHNlYXJjaHwxfHxjdXRlJTIwYW5pbWFsJTIwZmFjZXN8ZW58MHx8fHwxNzU1MDMxMDU1fDA&ixlib=rb-4.1.0&q=85')"}}></div>
        <div className="absolute top-2 left-40 w-28 h-28 bg-cover bg-center rounded-full border-4 border-white shadow-xl opacity-85" style={{backgroundImage: "url('https://images.unsplash.com/photo-1710780126902-a29d3a89bf7f?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2Mzl8MHwxfHNlYXJjaHwyfHxjdXRlJTIwYW5pbWFsJTIwZmFjZXN8ZW58MHx8fHwxNzU1MDMxMDU1fDA&ixlib=rb-4.1.0&q=85')"}}></div>
        <div className="absolute top-2 right-40 w-30 h-30 bg-cover bg-center rounded-full border-4 border-white shadow-xl opacity-90" style={{backgroundImage: "url('https://images.unsplash.com/photo-1628788985444-27871e39a1df?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2Mzl8MHwxfHNlYXJjaHwzfHxjdXRlJTIwYW5pbWFsJTIwZmFjZXN8ZW58MHx8fHwxNzU1MDMxMDU1fDA&ixlib=rb-4.1.0&q=85')"}}></div>
        <div className="absolute top-2 right-2 w-32 h-32 bg-cover bg-center rounded-full border-4 border-white shadow-xl opacity-90" style={{backgroundImage: "url('https://images.unsplash.com/photo-1726562530228-704147f55249?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2Mzl8MHwxfHNlYXJjaHw0fHxjdXRlJTIwYW5pbWFsJTIwZmFjZXN8ZW58MHx8fHwxNzU1MDMxMDU1fDA&ixlib=rb-4.1.0&q=85')"}}></div>
        
        {/* Left Border Animals */}
        <div className="absolute left-2 top-1/4 w-28 h-28 bg-cover bg-center rounded-full border-4 border-white shadow-xl opacity-85" style={{backgroundImage: "url('https://images.unsplash.com/photo-1609103566358-ccab56549f8d?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NjZ8MHwxfHNlYXJjaHwyfHxhbmltYWwlMjBwb3J0cmFpdHN8ZW58MHx8fHwxNzU1MDMxMDYzfDA&ixlib=rb-4.1.0&q=85')"}}></div>
        <div className="absolute left-2 top-3/4 w-32 h-32 bg-cover bg-center rounded-full border-4 border-white shadow-xl opacity-90" style={{backgroundImage: "url('https://images.unsplash.com/photo-1648615112210-37b804dfad1b?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NjZ8MHwxfHNlYXJjaHwzfHxhbmltYWwlMjBwb3J0cmFpdHN8ZW58MHx8fHwxNzU1MDMxMDYzfDA&ixlib=rb-4.1.0&q=85')"}}></div>
        
        {/* Right Border Animals */}
        <div className="absolute right-2 top-1/4 w-30 h-30 bg-cover bg-center rounded-full border-4 border-white shadow-xl opacity-90" style={{backgroundImage: "url('https://images.unsplash.com/photo-1648615112483-aeed3ce1385e?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NjZ8MHwxfHNlYXJjaHw0fHxhbmltYWwlMjBwb3J0cmFpdHN8ZW58MHx8fHwxNzU1MDMxMDYzfDA&ixlib=rb-4.1.0&q=85')"}}></div>
        <div className="absolute right-2 top-3/4 w-28 h-28 bg-cover bg-center rounded-full border-4 border-white shadow-xl opacity-85" style={{backgroundImage: "url('https://images.pexels.com/photos/2123375/pexels-photo-2123375.jpeg')"}}></div>
        
        {/* Bottom Border Animals */}
        <div className="absolute bottom-2 left-2 w-30 h-30 bg-cover bg-center rounded-full border-4 border-white shadow-xl opacity-90" style={{backgroundImage: "url('https://images.unsplash.com/photo-1674980750262-260775bf2212?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2Mzl8MHwxfHNlYXJjaHwxfHxjdXRlJTIwYW5pbWFsJTIwZmFjZXN8ZW58MHx8fHwxNzU1MDMxMDU1fDA&ixlib=rb-4.1.0&q=85')"}}></div>
        <div className="absolute bottom-2 left-40 w-32 h-32 bg-cover bg-center rounded-full border-4 border-white shadow-xl opacity-90" style={{backgroundImage: "url('https://images.unsplash.com/photo-1710780126902-a29d3a89bf7f?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2Mzl8MHwxfHNlYXJjaHwyfHxjdXRlJTIwYW5pbWFsJTIwZmFjZXN8ZW58MHx8fHwxNzU1MDMxMDU1fDA&ixlib=rb-4.1.0&q=85')"}}></div>
        <div className="absolute bottom-2 right-40 w-28 h-28 bg-cover bg-center rounded-full border-4 border-white shadow-xl opacity-85" style={{backgroundImage: "url('https://images.unsplash.com/photo-1628788985444-27871e39a1df?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2Mzl8MHwxfHNlYXJjaHwzfHxjdXRlJTIwYW5pbWFsJTIwZmFjZXN8ZW58MHx8fHwxNzU1MDMxMDU1fDA&ixlib=rb-4.1.0&q=85')"}}></div>
